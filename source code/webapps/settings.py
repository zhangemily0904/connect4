...
SECRET_KEY = "django-insecure-@sx9d9)8-obull18mg9==582aa153ucv7_6=w%l&t%xv_b^(v2"
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = CONFIG.get("GoogleOAuth2", "ID")
...
MEDIA_ROOT = BASE_DIR / 'connect4/static/media'